...
| <a name="input_logging"></a> [logging](#input\_logging) | Map containing access bucket logging configuration. | <pre>object({<br>    target_bucket = string<br>    target_prefix = optional(string)<br>    target_object_key_format = optional(list(object({<br>      partitioned_prefix = optional(list(string))<br>      simple_prefix      = optional(list(any))<br>    })))<br>  })</pre> | `null` | no |
